  ...
  <header class="bg-teal-600 text-white shadow-lg print:hidden">
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="md:hidden">
          <button on:click={toggleMenu} class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-4">
          <a href="https://www.facebook.com/KKSylhet" class=" hover:text-gray-200">
...
<style>
  ...
  .nav-link:not(.active) {
    @apply text-teal-100 hover:bg-teal-700 hover:text-white;
  }
  .nav-link.active {
