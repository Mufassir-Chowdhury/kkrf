...
<div class="print:hidden w-full flex justify-center gap-4 my-8">
  ...
  <button
    class="bg-secondary-600 text-white py-3 px-8 rounded-md hover:bg-secondary-700 transition-colors text-lg font-semibold shadow-card"
...
{#if loading}
  <div class="text-center p-12">
    <p class="text-lg text-primary-800">লোড হচ্ছে...</p>
  </div>
{:else if error}
